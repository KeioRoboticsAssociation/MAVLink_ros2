...
#include "stm32_mavlink_uart/msg/robomaster_motor_state.hpp"
#include "stm32_mavlink_uart/msg/robomaster_motor_config.hpp"
#include "stm32_mavlink_uart/srv/set_robomaster_motor_config.hpp"
#include "stm32_mavlink_uart/srv/get_robomaster_motor_config.hpp"
...
public:
    ...
    void motorCommandCallback(const stm32_mavlink_uart::msg::RobomasterMotorCommand::SharedPtr msg);

private:
    rclcpp::Node* node_;
    
    // ROS2 interfaces
    rclcpp::Publisher<stm32_mavlink_uart::msg::RobomasterMotorState>::SharedPtr motor_state_pub_;
    rclcpp::Service<stm32_mavlink_uart::srv::SetRobomasterMotorConfig>::SharedPtr set_config_srv_;
    rclcpp::Service<stm32_mavlink_uart::srv::GetRobomasterMotorConfig>::SharedPtr get_config_srv_;
    
    // Motor data structures
    struct MotorData {
        // Current state
        stm32_mavlink_uart::msg::RobomasterMotorState state;
        stm32_mavlink_uart::msg::RobomasterMotorConfig config;

        // Command tracking
        stm32_mavlink_uart::msg::RobomasterMotorCommand last_command;
    ...
    void setMotorConfigCallback(
        const std::shared_ptr<stm32_mavlink_uart::srv::SetRobomasterMotorConfig::Request> request,
        std::shared_ptr<stm32_mavlink_uart::srv::SetRobomasterMotorConfig::Response> response);
    void getMotorConfigCallback(
        const std::shared_ptr<stm32_mavlink_uart::srv::GetRobomasterMotorConfig::Request> request,
        std::shared_ptr<stm32_mavlink_uart::srv::GetRobomasterMotorConfig::Response> response);
    ...
    void buildMotorControlMessage(const stm32_mavlink_uart::msg::RobomasterMotorCommand& cmd, mavlink_message_t& msg, 
    ...
    void configToParameters(uint8_t motor_id, const stm32_mavlink_uart::msg::RobomasterMotorConfig& config);
    void parametersToConfig(uint8_t motor_id, stm32_mavlink_uart::msg::RobomasterMotorConfig& config);
