...
RobomasterController::RobomasterController(rclcpp::Node* node) : node_(node) {
    ...
    motor_state_pub_ = node_->create_publisher<stm32_mavlink_uart::msg::RobomasterMotorState>(
        "robomaster/motor_state", 10);
    
    // Create ROS2 services
    set_config_srv_ = node_->create_service<stm32_mavlink_uart::srv::SetRobomasterMotorConfig>(
        "robomaster/set_motor_config",
        std::bind(&RobomasterController::setMotorConfigCallback, this, 
                  std::placeholders::_1, std::placeholders::_2));
    
    get_config_srv_ = node_->create_service<stm32_mavlink_uart::srv::GetRobomasterMotorConfig>(
...
void RobomasterController::motorCommandCallback(const stm32_mavlink_uart::msg::RobomasterMotorCommand::SharedPtr msg) {
...
void RobomasterController::buildMotorControlMessage(const stm32_mavlink_uart::msg::RobomasterMotorCommand& cmd,
...
void RobomasterController::configToParameters(uint8_t motor_id, 
                                             const stm32_mavlink_uart::msg::RobomasterMotorConfig& config) {
