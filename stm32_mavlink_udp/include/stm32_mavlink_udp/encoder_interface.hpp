...
#include <vector>
#include <mutex>
#include "stm32_mavlink_udp/msg/encoder_state.hpp"
#include "stm32_mavlink_udp/msg/encoder_config.hpp"
#include "stm32_mavlink_udp/srv/set_encoder_config.hpp"
...
private:
    ...
    // ROS2 interfaces
    rclcpp::Publisher<stm32_mavlink_udp::msg::EncoderState>::SharedPtr encoder_state_pub_;
    rclcpp::Service<stm32_mavlink_udp::srv::SetEncoderConfig>::SharedPtr encoder_config_srv_;
    ...
    // Callbacks
    void encoderConfigCallback(const std::shared_ptr<stm32_mavlink_udp::srv::SetEncoderConfig::Request> request,
